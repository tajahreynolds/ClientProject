...
public class BookList<T> implements ListInterface<T> {
	...
	public void clear() {
		// The cast is safe because the new array contains null entries
		@SuppressWarnings("unchecked")
		T[] tempList = (T[]) new Object[numberOfEntries + 1];
		list = tempList;
		numberOfEntries = 0;
	}
	...
	private void checkInitialization() {
		if (!initialized)
			throw new SecurityException("BookList object is not initialized properly.");
